...
Select Phong.Maphong, sum(Dichvu.Dongia) as total 
from Dichvu join Sudungdv on Dichvu.Madichvu = Sudungdv.Madichvu 
join Phong on Phong.Maphong = Sudungdv.Maphong
Group by Phong.Maphong,Phong.Maphong

Select Maphong,Tieuthu*(Select Dongia from Dichvu where Madichvu = 'DV02') as total from Hoadondiennuoc where Mahoadon like 'Mhdd%'


Select Maphong,Tieuthu*(Select Dongia from Dichvu where Madichvu = 'DV03') as total from Hoadondiennuoc where Mahoadon like 'Mhdn%'

Select * from (Select Maphong,Tieuthu*(Select Dongia from Dichvu where Madichvu = 'DV02') as total from Hoadondiennuoc where Mahoadon like 'Mhdd%')
cross join (Select Maphong,Tieuthu*(Select Dongia from Dichvu where Madichvu = 'DV03') as total from Hoadondiennuoc where Mahoadon like 'Mhdn%') 
